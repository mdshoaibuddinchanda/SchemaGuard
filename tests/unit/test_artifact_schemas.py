...
def test_every_named_contract_rejects_unknown_top_level_keys() -> None:
    assert set(SCHEMA_CONTRACTS) == {
        "cache_artifact_manifest.schema.json",
        "cache_completion_marker.schema.json",
        "cache_identity.schema.json",
        "cache_scheduler_config.schema.json",
        "cache_scheduler_fault_evidence.schema.json",
        "cache_scheduler_fault_record.schema.json",
        "cache_scheduler_inventory.schema.json",
        "cache_scheduler_protected_hash_comparison.schema.json",
        "cache_scheduler_protected_hash_record.schema.json",
        "cache_scheduler_probe_evidence.schema.json",
        "cache_scheduler_probe_run.schema.json",
        "cache_scheduler_probe_resource.schema.json",
        ...
        "pilot_condition.schema.json",
        "pilot_condition_inventory.schema.json",
        "pilot_staged_schedule.schema.json",
        "pilot_dataset_selection.schema.json",
        "pilot_decision_policy.schema.json",
        "pilot_metric_policy.schema.json",
        "pilot_protocol.schema.json",
        "pilot_protocol_validation.schema.json",
        ...
        "scheduler_run_manifest.schema.json",
        "scheduler_run_plan.schema.json",
        "scheduler_state.schema.json",
        "scheduler_failure_record.schema.json",
        "scheduler_resource_record.schema.json",
        "scheduler_task_attempt.schema.json",
        "scheduler_task_record.schema.json",
        "scheduler_task_result.schema.json",
        "scheduler_task_spec.schema.json",
        "scheduler_task_transition.schema.json",
        "smoke_condition.schema.json",
        "smoke_condition_resource.schema.json",
        "smoke_config.schema.json",
        "smoke_evidence_inventory.schema.json",
        "smoke_metric.schema.json",
        "smoke_paired_metric.schema.json",
        "smoke_protected_foundation_hash_comparison.schema.json",
        "smoke_protected_split_validation.schema.json",
        "smoke_plan.schema.json",
        "smoke_prediction_file.schema.json",
        "smoke_resume_verification.schema.json",
        "smoke_run_report.schema.json",
        "smoke_runtime_estimate.schema.json",
        "smoke_validation_report.schema.json",
